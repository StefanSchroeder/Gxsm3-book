...
Physics\footnote{Institut für Festkörperphysik, Universität Hannover,
...
\item Extremely flexible configuration of user settings and data
 ...
 \item Image filtering 1D and 2D, including several Fourier
 ...
 \item Digital Instruments/Veeco Metrology Group, NanoScope (import) (\GxsmWWW{veeco.com}, see \ref{pi:nanoimport})
...
% \item CCD control (very special, just for gurus)
 ...
 \item A Plug-in categorizing mechanism automatically only loads the
...
\item Python Remote Control Interface: The \Gxsm\ scanning progress is fully
